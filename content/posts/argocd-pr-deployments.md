...
description: "Learn how we implemented GitOps-based preview environments with ArgoCD on AWS EKS. Each pull request automatically gets its own isolated Kubernetes environment with automatic cleanup."
featured: true
---
...
<img alt="ArgoCD Preview Deployment Architecture" src="/images/argocd-pr-deployment-diagram.png" width="1280" height="720"/>
...
<img alt="GitHub Actions preview deployment run" src="/images/argocd-github-action.png" width="1280" height="720"/>
...
build-scan-push:
  ...
  steps:
    ...
    - name: Configure AWS credentials
      ...
      uses: aws-actions/configureaws-credentials@v4
      with:
...
<img alt="Argocd PR Deployed" src="/images/argocd-pr-deployed.png" width="1280" height="720"/>
...
<img alt="Adding comments in PR" src="/images/argocd-pr-comment.png" width="1280" height="720"/>
